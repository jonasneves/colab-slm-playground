...
| [Gemma 4 31B vLLM Chatbot](gemma4_vllm_chatbot_colab.ipynb) | A100 GPU | Runs [Gemma-4-31B-IT-NVFP4](https://huggingface.co/nvidia/Gemma-4-31B-IT-NVFP4) via vLLM with NVIDIA FP4 quantization. Requires a high-VRAM GPU (A100 recommended). | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jonasneves/colab-slm-playground/blob/main/gemma4_vllm_chatbot_colab.ipynb) |
